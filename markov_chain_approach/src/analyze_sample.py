...
if __name__ == "__main__":
    ...
    for i, col in enumerate(numeric_cols):
        ...
        pos+=1
    plt.tight_layout()
    plt.savefig(f"{output_dir}/numerical_variables.pdf")
    ...
    plt.tight_layout()
    plt.savefig(f"{output_dir}/behavior_correlation_heatmaps.pdf")  # Save the heatmaps
    ...
    graph.render(f"{output_dir}/treeSchema")
